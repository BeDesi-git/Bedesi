...
namespace BeDesi.Core.Services
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendWelcomeEmailAsync(string userName, string businessName, string businessEmail, string password)
        {
            ...
            string htmlBody = @"
                ...
                <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;'>
                    <div style='width: 100%; max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;'>
                        <h2 style='color: #4CAF50; margin-top: 0;'>Welcome to Bedesi.co.uk!</h2>
                        ...
                        <p>If you need any assistance, feel free to reach out to our support team at <a href='mailto:support@bedesi.co.uk' style='color: #4CAF50; text-decoration: none;'>support@bedesi.co.uk</a>.</p>
            ...
            htmlBody = htmlBody.Replace("[User's Full Name]", userName)
                               ...
                               .Replace("[User's Username]", businessEmail)
                               .Replace("[User's Password]", password);

             await SendEmailAsync(businessEmail, subject, htmlBody);
        }
    }
}
